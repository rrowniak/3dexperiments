...
#define POLY4DV2_ATTR_RGB32                 0x0020
...
#define RENDERLIST4DV2_MAX_POLYS          10000
...
void Draw_Textured_Triangle32(POLYF4DV2_PTR face, UCHAR *dest_buffer, int mem_pitch);
