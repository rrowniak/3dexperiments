...
void VECTOR2D_Print(VECTOR2D_PTR va, const char *name);
...
void VECTOR3D_Print(VECTOR3D_PTR va, const char *name);
...
void VECTOR4D_Print(VECTOR4D_PTR va, const char *name);
...
void Print_Mat_4X4(MATRIX4X4_PTR ma, const char *name);
...
void QUAT_Print(QUAT_PTR q, const char *name);
