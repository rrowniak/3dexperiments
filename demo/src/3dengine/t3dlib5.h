...
void Draw_OBJECT4DV1_Wire32(OBJECT4DV1_PTR obj, UCHAR *video_buffer, int lpitch);

void Draw_RENDERLIST4DV1_Wire16(RENDERLIST4DV1_PTR rend_list, UCHAR *video_buffer, int lpitch);

void Draw_RENDERLIST4DV1_Wire32(RENDERLIST4DV1_PTR rend_list, UCHAR *video_buffer, int lpitch);
